...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.relu1 = nn.ReLU() # added for pruning/quantization compatibility
        ...
        self.relu2 = nn.ReLU() # added for pruning/quantization compatibility
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.residual_eltwise_add = EltwiseAdd() # added for pruning/quantization compatibility
        self.relu3 = nn.ReLU() # added for pruning/quantization compatibility
...
def resnet18_cifar100(pretrained=None):
...
def resnet34_cifar100(pretrained=None):
...
def resnet50_cifar100(pretrained=None):
...
def resnet101_cifar100(pretrained=None):
...
def resnet152_cifar100(pretrained=None):
